...
''   1o_111_bbb__ss_000_DLR__xy_dd_ll_rr__pppp_eeee
...
'' pppp operation :  +, -, *, /, %, <<, >> &, |, ^, ~, NOTHING (use right)
''
...
final    wrlong    tmpL,boxDat1Ret     ' Final result from tmpL               
  ...
  if_nz  mov       tmpL,#VariableBoxNumber ' ... release the lock on ...
  if_nz  lockclr   tmpL                    ' ... behalf of the caller
