' This engine must stay one row ahead of the DisplayBeamRowNumber. The display will pause
' after drawing row 8 (vertical retrace) giving the engine time to move the sprites AND
' prepare row 0.

   {
32 + 256 + 32 = 320 pixels per row
320 / 4 = 80 bytes

Odd/even = 160 bytes
Mask/image = 320 bytes
Two sets = 640 bytes
}
