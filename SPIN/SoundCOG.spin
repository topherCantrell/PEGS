'
' For sound command use a bit to indicate whether waveform should be
' reset. For manual volume/frequency sweep applications it sounds
' better if not.
'
PUB start 
  
  coginit(4,@SoundCOG,0)
...
' SoundCOG uses box 3
boxComStat long $7EE0
boxDat1Ret long $7EE4
boxDat2    long $7EE8
boxDat3    long $7EEC
boxDat4    long $7EF0
boxDat5    long $7EF4
...
randomSeed long $00_B4_F0_1A  ' Noise random number seed   
