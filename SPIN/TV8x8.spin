...
:black                  call    #hsync                  'do hsync
                        ...
                        mov     onum,#0
                        mov     overlayMask,#SORMaskEven
                        mov     ovImage,#SORImageEven     
...
:tile                   rdword  tile,screen             'read tile                           
                        ...
                        add     overlayMask,#4
                        cmp     overlayMask,#SORImageEven wz                                             

                        rdlong  oimage,ovImage                          
                        add     ovImage,#4                         
                        
                    if_z mov     overlayMask,#SORMaskEven
                    if_z mov     ovImage,#SORImageEven wz ' Note we reset the Z flag here like it was coming in
...
overlayMask      long  SORMaskEven        
ovImage          long  SORImageEven
omask    long 0
oimage   long 0
onum     long 0
overlayRowNum    long  ActivelyDrawnRow
